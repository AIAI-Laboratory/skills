...
```bash
npx skills add AIAI-Laboratory/skills
```

## Install one skill

```bash
npx skills add AIAI-Laboratory/skills --skill <skill-name>
```
...
- Codex: `~/.codex/skills/`
- Antigravity: install as native plugin instead — `agy plugin install https://github.com/AIAI-Laboratory/skills.git`
